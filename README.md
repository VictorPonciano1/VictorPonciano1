# Olá, Mundo! Sou Victor Ponciano - Desenvolvedor Full Stack em Formação 👋

Olá, meu nome é Victor, tenho 20 anos, sou do Brasil 🇧🇷 e estou em treinamento/formação para me tornar um Desenvolvedor Full Stack.

Atualmente trabalho na empresa "Foursys Tech Ltda." como "Desenvolvedor Jr" e estudo na Faculdade FATEC no curso de ADS - Análise e Desenvolvimento de Sistemas (atualmente 5/6 Semestres).
...
+ **[lab-azure-fundamentals-dio](https://github.com/VictorPonciano1/lab-azure-fundamentals-dio)** - Laboratórios para treinos dos conceitos Azure focados na Certificação AZ900
